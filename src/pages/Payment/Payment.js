...
export const Payment = () => {
    ...
    (async () => {
      try {
        const { data } = await axios.get(
          `https://travel-app-vm2w.onrender.com/api/hotels/${id}`
        );
        setSingleHotel(data);
      } catch (err) {
        console.log(err);
  ...
  const handleConfirmBookingClick = async () => {
    ...
    const options = {
      key: "rzp_test_R8oVvmeosAtPDA",
      amount: totalPayableAmount * 100,
      currency: "INR",
      name: "LetsTravel",
      email: "SheetalChouhan7073@gmail.com",
      contact: "9876598210",
      ...
      <main className="payment-page d-flex justify-center">
        ...
        <div className="final-details d-flex direction-column gap-large">
          ...
          <div className="tag">
            ...
            <strong className="strong">Travel</strong> cover
          </div>
