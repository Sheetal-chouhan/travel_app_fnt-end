    ...
    return (
        <header className="heading d-flex align-center">
            ...
            <div className="form-container d-flex align-center cursor-pointer shadow " onClick={handleSearchClick}>
                ...
                {checkInDate && checkOutDate ?  `${checkInDate.toLocaleDateString("en-US" , {day: "numeric", month: "short"})} - ${ checkOutDate.toLocaleDateString("en-US" , {day: "numeric", month: "short"})  }` : "Any Where"}
                </span>
                <span className="border-right-1px"></span>
