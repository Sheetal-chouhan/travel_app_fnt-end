...
//                 <div className="d-flex direction-column lb-in-container">
//                     <label
//                         className="auth-label">Name<span className="asterisk">*</span>{" "}
//                     </label>
//                     <input
...
//                 <div className="d-flex direction-column lb-in-container">
//                     <label
//                         className="auth-label">Email<span className="asterisk">*</span>{" "}
//                     </label>
//                     <input
//                         defaultValue={email}
//                         className="auth-input"
...
//                 <div className="d-flex direction-column lb-in-container">
//                     <label
//                         className="auth-label">Confirm Password<span className="asterisk">*</span>{" "}
//                     </label>
//                     <input
...
//                 <div>
//                     <button className="button btn-primary btn-login cursor" onChange={handleFormSubmit}>Submit</button>
//                 </div>
//             </form>
